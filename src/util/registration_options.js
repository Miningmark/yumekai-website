...
export const REGISTRATION_END_VENDOR = new Date("2026-03-10T18:00:00");

export const REGISTRATION_START_EXHIBITOR = new Date("2025-12-12T12:00:00");
export const REGISTRATION_END_EXHIBITOR = new Date("2026-03-10T18:00:00");

export const REGISTRATION_START_SHOWACT = new Date("2025-12-12T12:00:00");
export const REGISTRATION_END_SHOWACT = new Date("2026-02-28T18:00:00");

export const REGISTRATION_START_WORKSHOP = new Date("2025-12-12T12:00:00");
export const REGISTRATION_END_WORKSHOP = new Date("2026-03-10T18:00:00");

export const REGISTRATION_START_COSPLAY_PERFORMANCE = new Date("2025-10-05T12:00:00");
export const REGISTRATION_END_COSPLAY_PERFORMANCE = new Date("2026-05-09T18:00:00");

export const REGISTRATION_START_COSPLAY_CRAFTING = new Date("2025-10-05T12:00:00");
export const REGISTRATION_END_COSPLAY_CRAFTING = new Date("2026-05-02T23:59:00");
