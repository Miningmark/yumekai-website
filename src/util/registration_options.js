...
export const REGISTRATION_END_COSPLAY_PERFORMANCE = new Date("2025-12-17T18:00:00");

export const REGISTRATION_START_COSPLAY_CRAFTING = new Date("2025-10-05T12:00:00");
export const REGISTRATION_END_COSPLAY_CRAFTING = new Date("2025-12-17T18:00:00");

export const REGISTRATION_START_ART_CONTEST = new Date("2025-10-05T12:00:00");
export const REGISTRATION_END_ART_CONTEST = new Date("2025-12-17T18:00:00");
