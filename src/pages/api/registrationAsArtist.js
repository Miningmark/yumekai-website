...
export default async function handler(req, res) {
  ...
  if (typeof dataStorage !== "boolean") {
    errors.push({
      field: "dataStorage",
      message: "Datenspeicherung muss angegeben werden",
    });
  }
  if (typeof licensedMusic !== "boolean") {
    errors.push({
      field: "licensedMusic",
      message: "Lizenzmusik muss angegeben werden",
    });
  }
  if (typeof pictureRights !== "boolean") {
    errors.push({
      field: "pictureRights",
      message: "Bildrechte müssen angegeben werden",
    });
  }
  if (typeof artistConditions !== "boolean") {
    errors.push({
      field: "artistConditions",
      message: "Künstlerbedingungen müssen angegeben werden",
    });
  }
