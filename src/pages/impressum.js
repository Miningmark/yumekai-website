...
export default function Impressum() {
  return (
    <>
      ...
      <p>
        § 2 Externe Links <br /> Diese Website enthält Verknüpfungen zu Websites Dritter („externe
        Links“). Diese Websites unterliegen der Haftung der jeweiligen Betreiber. Der Anbieter hat
        bei der erstmaligen Verknüpfung der externen Links die fremden Inhalte daraufhin überprüft,
      ...
      <p>
        § 4 Besondere Nutzungsbedingungen <br /> Soweit besondere Bedingungen für einzelne Nutzungen
