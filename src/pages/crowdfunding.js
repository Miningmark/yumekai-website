...
export default function Shop() {
  return (
    <>
      ...
      <p>
        <br />
        Falls das Widget nicht lädt kannst du den Crowdfunding-shop unter{" "}
            ...
            <noscript>
                <div class="pretix-widget">
                    <div class="pretix-widget-info-message">
                        JavaScript ist in Ihrem Browser deaktiviert. Um unseren Ticketshop ohne JavaScript aufzurufen, klicken Sie bitte <a target="_blank" rel="noopener" href="https://pretix.eu/Dreamfly-Events/crowdfunding/">hier</a>.
                    </div>
                </div>
            </noscript>
            `,
